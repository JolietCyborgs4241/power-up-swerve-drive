...
MagEncoder* Robot::magEncoder = NULL;
...
void Robot::RobotInit() {
	...
	//AutoChooser -> AddDefault("Auto", new AutoLeft());
...
void Robot::SMDB() {
	...
	SmartDashboard::PutNumber("Intake", intakeDetection->GetRangeInches());
	SmartDashboard::PutNumber("MagEncoder", magEncoder->GetDistance());
