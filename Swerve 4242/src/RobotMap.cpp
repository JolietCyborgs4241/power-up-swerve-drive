...
void RobotMap::init() {
    ...
    driveTrainRearRight->SetOutputRange(-0.9, 0.9);
    ...
    driveTrainFrontLeft->SetOutputRange(-0.9, 0.9);
    ...
    driveTrainFrontRight->SetOutputRange(-.9, .9);
    ...
    driveTrainRearLeft->SetOutputRange(-.9, .9);
